...
import { ArrowRight, Leaf, Award, Package, DollarSign, Eye, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1693593785503-5bfee6d1d5ca')`,
        }}
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                <span className="font-semibold text-emerald-700">{companyInfo.name}</span> is a trusted producer and exporter of premium organic vetiver products. We specialize in delivering 100% pure vetiver roots, essential oils, and powder to global markets.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our commitment to purity, sustainability, and international quality standards ensures that every product meets the highest benchmarks for perfumery, aromatherapy, cosmetics, and herbal applications.
              </p>
              <Link to="/about">
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-700 to-emerald-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/contact">
            <Button size="lg" className="bg-white text-emerald-800 hover:bg-gray-100 px-8 py-6 text-lg font-semibold">
              Contact Us Today
              <ArrowRight className="ml-2" size={20} />
            </Button>
          </Link>
